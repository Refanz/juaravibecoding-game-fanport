...
export default function ElevatorModal({ currentFloor, onSelectFloor, onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/80 backdrop-blur-sm animate-fade-in">
      <div className="bg-dark/95 border-2 border-hospital-sky rounded-lg p-6 w-[90%] max-w-sm flex flex-col items-center gap-4 shadow-[0_0_20px_rgba(214,228,240,0.2)]">
