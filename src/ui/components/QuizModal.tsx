...
export default function QuizModal({ quiz, onCorrect, onWrong }: Props) {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-100 p-2 sm:p-4 animate-fade-in" id="quiz-modal">
      <div className="bg-dark border-2 border-hospital-blue rounded-lg p-4 sm:p-6 max-w-[580px] w-full max-h-[95dvh] overflow-y-auto custom-scrollbar flex flex-col gap-3 sm:gap-4 my-auto shrink-0">
