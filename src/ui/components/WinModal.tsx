...
export default function WinModal({ onReturnToWelcome }: Props) {
  return (
    <div className="fixed inset-0 bg-black/88 flex items-center justify-center z-300 animate-fade-in p-2 sm:p-4">
      <div className="bg-dark border-2 border-medical-green rounded-lg p-6 sm:p-8 text-center flex flex-col gap-4 sm:gap-5 max-w-[400px] w-full max-h-[95vh] overflow-y-auto custom-scrollbar">
