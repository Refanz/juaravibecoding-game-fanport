...
const SVG_DEFS: Record<string, string> = {
  wall: `<svg xmlns="http://www.w3.org/2000/svg" width="48" height="96">
    <!-- Top surface (lighter) -->
    <rect x="0" y="0" width="48" height="48" fill="#64b5f6"/>
    <!-- Front surface (darker) -->
    <rect x="0" y="48" width="48" height="48" fill="#1e88e5"/>
    <!-- Outline -->
    <rect x="0" y="0" width="48" height="96" fill="none" stroke="#1565c0" stroke-width="2"/>
    <!-- Inner separating line -->
    <line x1="0" y1="48" x2="48" y2="48" stroke="#1565c0" stroke-width="2"/>
  </svg>`,
  wallVertical: `<svg xmlns="http://www.w3.org/2000/svg" width="48" height="96">
    <!-- Top surface (lighter) -->
    <rect x="18" y="0" width="12" height="48" fill="#64b5f6"/>
    <!-- Front surface (darker) -->
    <rect x="18" y="48" width="12" height="48" fill="#1e88e5"/>
    <!-- Outline -->
    <rect x="18" y="0" width="12" height="96" fill="none" stroke="#1565c0" stroke-width="2"/>
    <!-- Inner separating line -->
    <line x1="18" y1="48" x2="30" y2="48" stroke="#1565c0" stroke-width="2"/>
  </svg>`,
  door: `<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48">
    <rect x="0" y="24" width="48" height="24" fill="#a1887f"/>
    <rect x="0" y="24" width="48" height="4" fill="#6d4c41"/>
    <rect x="0" y="44" width="48" height="4" fill="#6d4c41"/>
    <rect x="0" y="24" width="4" height="24" fill="#6d4c41"/>
    <rect x="44" y="24" width="4" height="24" fill="#6d4c41"/>
    <line x1="24" y1="24" x2="24" y2="48" stroke="#6d4c41" stroke-width="2"/>
  </svg>`,
